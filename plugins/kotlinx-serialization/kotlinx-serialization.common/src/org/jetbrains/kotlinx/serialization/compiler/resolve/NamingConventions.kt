...
object SerialEntityNames {
    ...
    val KSERIALIZER_NAME_CLASS_ID = ClassId.topLevel(KSERIALIZER_NAME_FQ)
...
object SerialClassIds {
    val KSERIALIZER_CLASS_ID = KSERIALIZER_CLASS.serializationId()

    private fun String.serializationId(): ClassId {
        return ClassId(SerializationPackages.packageFqName, Name.identifier(this))
    }
}
